...
<%-- ページタイトルを設定する。 --%>
<% pageContext.setAttribute("title", "読書記録の更新", PageContext.PAGE_SCOPE); %>
...
<body>
	<div class="container my-4">
		...
		<div class="m-4">
			<div>
				<h2>
					読書記録を更新してください<span class="subtitel warning">
						(※のある箇所は必ず入力してください。)</span>
				</h2>
			</div>
			<div class="form-space">
				<form action="${ root_path }/RecordOfReadingUpdate" method="post">
					...
					<div class="row form-object">
						<div class="col">
							<button type="submit" class="btn btn-approval">更新</button>
						</div>
				</form>
				<div class="col">
